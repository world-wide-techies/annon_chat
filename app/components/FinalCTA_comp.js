...
function FinalCTA(){
  return (
    <div className="mt-2">
      <div className="bg-purple-bg bg-cover flex flex-row justify-between p-4 rounded-[90px] w-[90%] m-auto">
        <div className="m-auto">
          <p className="text-4xl text-white mb-5">Ready to Chat Now?</p>
          <div className="flex flex-row gap-4">
            <button className="flex flex-row justify-center text-center bg-white px-9 py-2 space-x-2 rounded-3xl">
              <Image src={chatIcon} alt="chatIcon"/>
              <p className="text-[#2C1FA3] font-medium">Start a Chat</p>
            </button>
            <button className="flex flex-row justify-center text-center bg-transparent border-[2px] border-white text-white px-9 py-2 space-x-2 rounded-3xl">
