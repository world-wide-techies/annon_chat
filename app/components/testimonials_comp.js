      ...
      <div className="w-[1029px] flex flex-col h-screen space-y-[50px] justify-center mx-auto">
        <div className=" w-[673px] relative px-3 py-4 self-end bg-gradient-to-r  from-fuchsia-800 to-pink-500 rounded-[11px] ">
          ...
          <div className="text-white text-base font-normal leading-tight">
            ...
            we&apos;re done? Genius! Highly recommend it for anyone looking for
            secure and spontaneous conversations. 🙌&quot;
          </div>
        ...
        <div className="w-[673px] relative self-start  px-3 py-4 bg-white rounded-[11px]">
          ...
          <div className="text-neutral-800 text-base font-normal leading-tight">
            ...
            room and share the link with my classmates. We can discuss our ideas
            without the pressure of face-to-face interactions, and it keeps our
            conversations focused and efficient. Thanks to AnonChat, group
            projects have become way less stressful! 🎓💬&quot;
            <br />
          </div>
        ...
        <div className="w-[673px] relative self-end px-3 py-4 bg-gradient-to-r from-fuchsia-800 to-pink-500 rounded-[11px] ">
          ...
          <div className="self-stretch text-white text-base font-normal leading-tight">
            ...
            anonymous feature lets us share our innermost thoughts without any
            reservations, making our chats more intimate and authentic. Plus,
            the time-limited aspect keeps our conversations fresh and exciting.
            AnonChat has become our go-to platform for meaningful heart-to-heart
            talks. ❤️🗣️&quot;
          </div>
          <div className="self-stretch text-right text-white text-base font-normal leading-tight">
            Lisa M., 27
