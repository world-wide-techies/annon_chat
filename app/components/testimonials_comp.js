...
const Testimonials = () => {
  return (
    <div>
      <div className="w-[100%] h-[1078px] relative bg-gradient-to-b from-indigo-500 to-indigo-800">
        ...
        <div className="w-[887px] left-[50%] top-[100px] absolute text-center text-white text-5xl font-medium leading-[54px]">
